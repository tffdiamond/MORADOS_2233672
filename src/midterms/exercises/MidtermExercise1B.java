...
/*
Name: Lou Diamond T. Morados, Date: October 10, 2022,
Problem:
...
public class MidtermExercise1B {
    public static void main(String[] args) {
        ...
        int quizScore = 0;
        int examScore = 0;
        int perfectQuizScore = 0;
        int perfectExamScore = 0;
        double quizGrade; // 1.
        double examGrade; // 2.
        double prelimGrade = 0; // 3.

        while (perfectQuizScore <= 0) {
            System.out.println("Enter the Perfect Total Quiz Score:");
            ...
            if (perfectQuizScore <= 0) {
                ...
                while (quizScore <= perfectQuizScore) {
                    ...
                    quizScore = Integer.parseInt(reader.nextLine());
                            ...
                            if (perfectExamScore <= 0) {
                                ...
                                while (examScore <= perfectExamScore) {
                                    ...
                                    if (examScore > perfectExamScore) {
                                        ...
                                        //Computation for the prelimGrade
        ...
        if (prelimGrade >= 75) {
            System.out.print("Prelim Grade " + prelimGrade);
